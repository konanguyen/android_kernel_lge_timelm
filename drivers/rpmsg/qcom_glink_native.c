...
#define RPM_CMD_VERSION			GLINK_CMD_VERSION
#define RPM_CMD_VERSION_ACK		GLINK_CMD_VERSION_ACK
#define RPM_CMD_OPEN			GLINK_CMD_OPEN
#define RPM_CMD_CLOSE			GLINK_CMD_CLOSE
#define RPM_CMD_OPEN_ACK		GLINK_CMD_OPEN_ACK
#define RPM_CMD_INTENT			GLINK_CMD_INTENT
#define RPM_CMD_RX_DONE			GLINK_CMD_RX_DONE
#define RPM_CMD_RX_INTENT_REQ		GLINK_CMD_RX_INTENT_REQ
#define RPM_CMD_RX_INTENT_REQ_ACK	GLINK_CMD_RX_INTENT_REQ_ACK
#define RPM_CMD_TX_DATA			GLINK_CMD_TX_DATA
#define RPM_CMD_CLOSE_ACK		GLINK_CMD_CLOSE_ACK
#define RPM_CMD_TX_DATA_CONT		GLINK_CMD_TX_DATA_CONT
#define RPM_CMD_READ_NOTIF		GLINK_CMD_READ_NOTIF
#define RPM_CMD_RX_DONE_W_REUSE		GLINK_CMD_RX_DONE_W_REUSE
#define RPM_CMD_SIGNALS			GLINK_CMD_SIGNALS
